 ...
 * Решение - выделение абстракции для хранилища книг - интерфейса BookStorage, и от него нужно реализовать класс
 * LibBookStorage. Затем в классе Library нужно избавиться от зависимости на само хранилище путём замены приватного поля
 * с мапой на приватное поле хранилища:
